...
const MAP = {
  ...
  // ———— 第二期（全量替换语义徽章 / 页面按钮） ————
  'camera': 'System/Camera.svg',
  'image': 'Media/Image_01.svg',
  'tag': 'Interface/Tag.svg',
  'map-pin': 'Navigation/Map_Pin.svg',
  'desktop': 'System/Desktop.svg',
  'water-drop': 'Environment/Water_Drop.svg',
  'swap': 'Arrow/Arrow_Left_Right.svg',
  'calendar': 'Calendar/Calendar.svg',
  'cart': 'Interface/Shopping_Cart_01.svg',
  'return': 'Arrow/Arrow_Undo_Up_Left.svg',
  'edit': 'Edit/Edit_Pencil_01.svg',
  'bell-ring': 'Communication/Bell_Ring.svg',
  'speaker': 'Media/Volume_Max.svg',
  'list-check': 'Edit/List_Check.svg',
  'repeat': 'Arrow/Arrows_Reload_01.svg',
  'timer': 'Calendar/Timer.svg',
  'alarm': 'Calendar/Alarm.svg',
  'star': 'Interface/Star.svg',
  'link': 'Interface/Link.svg',
  'note': 'File/Note.svg',
  'folder': 'File/Folder.svg',
  'flag': 'Navigation/Flag.svg',
